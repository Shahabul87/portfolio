  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer text-black hover:opacity-[0.9] dark:text-white  hover:text-blue-500 flex items-center justify-center"
      >
       
        {item} <span> <ChevronDown className="h-4 w-4 mr-1"/></span>
      </motion.p>
      {active !== null && (
        <motion.div
